...
\newcommand\insertPage[2]{{\hoffset=-1in\voffset=-1in\shipout\vbox to 29.7cm{\vss\hbox to 21cm{\hss\includegraphics[page=#2,width=21cm,height=29.7cm]{#1}\hss}\vss}\stepcounter{page}}}
\newcommand\countPages[1]{\saveimageresource{#1}\setcounter{insertTotal}{\lastsavedimageresourcepages}}
