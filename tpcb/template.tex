...
\newcommand\insertPage[2]{\shipout\vbox to 29.7cm{\vss\hbox to 21cm{\hss{
%% TODO: include file !!
%\XeTeXpdffile #1 page #2
}\hss}\vss}\stepcounter{page}}
\newcommand\countPages[1]{\setcounter{insertTotal}{\pdfnumberofpages #1 }}
