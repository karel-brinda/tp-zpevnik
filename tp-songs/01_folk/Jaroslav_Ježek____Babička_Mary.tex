...
\Ch{Dmi}{pirát} zk\Ch{Ami}{rvavenou} šerpu ždímá, \Ch{H7}{kapitán} pucuje re\Ch{E}{volver}. 

\bigskip

\Ch{Ami}{Pikovická} rýžoviště zlata čeří se v příboji Sázavy, 

\Ch{Dmi}{ale} za to \Ch{Ami}{krčmářova} chata \Ch{Dmi}{křepčí} rykem \Ch{E7}{chlapské} zá\Ch{Ami}{bavy}. 

\bigskip

\Ch{G7}{Když} tu náhle, co se \Ch{C}{děje}, \Ch{G7}{divný} šelest houštím \Ch{C}{spěje}, 

\Ch{G7}{plch}, skunk, \Ch{C}{vše} utíká \Ch{F}{po} \Ch{F#dim}{stráni} od Medni\Ch{E}{ka}. 

\bigskip

\Ch{Ami}{Krčmář} zhasne, kovbojové ztichnou, pirát zděšen tvář si zakryje, 

\Ch{Dmi}{rudé} squaw se \Ch{Ami}{chvějí} a pak vzdychnou: \Ch{H7}{Blíží} se k nám postrach \Ch{E}{prérie.}\Ch{G7}{} 
\ks

\zr
\Ch{C}{Mary}, babička \Ch{D7}{Mary}, 

dva \Ch{G7}{kolťáky} za pasem, nad hlavou \Ch{C}{točí} lasem. 
