...
\zs
    \Ch{C}{Kouk}něte na toho \Ch{H7}{fintila} \Ch{Dmi7}{pod} krkem žlutého \Ch{G7}{motýla}					

    \Ch{Dmi7}{zelený} klobouček \Ch{G7}{do týla} \Ch{D7}{šoupne} si \Ch{G7}{na bílou} \Ch{C}{pleš.} \Ch{G+}{}		
\ks

\zs
    I když ten tralalák padá mi, hlavně že vyhrávám barvami

    hlavně že vyhrávám barvami, zase jsem šťastnej jak \Ch{C7}{veš}
\ks

\zr
    Co po mně \Ch{F}{chceš} pravdu či \Ch{Fmi}{lež}, zkust ty dvě \Ch{C}{rozeznat} a pak se \Ch{C7}{směj}

    barevný \Ch{F}{svět} láme mi \Ch{Fmi}{hřbet} \Ch{Emi}{přesto} chci \Ch{Ebdim}{být} šašek \Ch{Dmi7}{počmára}\Ch{G7}{nej.}
\kr
